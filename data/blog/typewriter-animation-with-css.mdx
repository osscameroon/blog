...
date: 2022-01-27T19:00:00Z
lastmod: '2022-01-27'
tags: ['tutorial', 'animation', 'css']
draft: false
summary: 'Typing text animation is one of the most popular animation and there are many libraries that help you do it. What if we could do it from scratch?'
layout: PostLayout
authors: ['yokwejuste']
---
