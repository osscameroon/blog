...
date: 2022-02-11T19:00:00Z
lastmod: '2022-02-11'
tags: ['tutorial', 'devops', 'castlemock']
draft: false
summary: 'In this post, we will learn how to set up a mocker server on Kubernetes with Helm to speed up your development speed on local environment'
layout: PostLayout
authors: ['blvckTheRippa']
canonicalUrl: https://dev.to/3logy/deploy-a-castlemock-mockserver-on-kubernetes-with-helm-41p8
---
