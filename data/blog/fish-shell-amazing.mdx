...
date: 2021-10-08T19:00:00Z
lastmod: '2021-10-08'
tags: ['tutorial', 'terminal']
draft: false
summary: 'Developer experience is paramount for a better developer productivity. A terminal is the most important tool for a developer; Fish is a new generation Terminal and I will share we you ehat are the benefits'
layout: PostLayout
authors: ['rmpr']
---
...
another time). Not so long ago, I decided to try it, and it&rsquo;s simply... amazing.

If I had to state one feature that makes me like to use it, it&rsquo;ll be the
...
available in the Fedora repo anyway.

For those interested, [here is acomparison between fisher, omf and fundle](https://github.com/jorgebucaran/fisher/issues/481)
...
[starship](https://github.com/starship/starship) and [tide](https://github.com/IlanCosman/tide).
I wish I could say more things on that, but I chose starship solely because it is on the Fedora repo :p
