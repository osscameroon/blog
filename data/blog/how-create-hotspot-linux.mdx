...
date: 2022-02-21T19:00:00Z
lastmod: '2022-02-21'
tags: ['tutorial', 'network', 'linux']
draft: false
summary: 'In this post, we will se how to create a Hotspot on Linux'
layout: PostLayout
authors: ['pythonbrad']
---
...
![Hotspot](/static/images/posts/create-hotspot-linux/hotspot.png)
