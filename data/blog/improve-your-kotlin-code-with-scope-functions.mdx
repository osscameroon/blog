---
title: Improve your kotlin code with scope functions
date: '2022-11-13'
tags: ['Kotlin', 'algorithm', 'beginner']
draft: false
summary: We are going to learn how and when to use kotlin's scope functions.
images: []
layout: PostLayout
canonicalUrl:
---
